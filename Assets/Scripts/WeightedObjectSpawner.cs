...
public class CollectableItem
{
    ...
    public int minSpawnRound; // e.g. set to 6 for “only after round 5”
}
...
public class WeightedObjectSpawner : MonoBehaviour
{
    ...
    private void SpawnCollectableObjects(GameObject obstacle)
    {
        ...
        // First, build a list of only those items we’re allowed to spawn right now:
        ...
        // Now do the usual weighted‐random for each spawn point
